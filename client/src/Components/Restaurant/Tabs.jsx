...
const Tab = (props) => {
    ...
    return (
        ...
        <div className={classnames("text-gray-500  relative font-regular ", {
            "text-zomato-300 font-semibold " : props.isActive
        })}      
        >               
...
const TabConatiner = (props) => {
    ...
    return (
        <>
          <div className="flex relative items-center pb-4 gap-8 overflow-x-scroll md:gap-20  border-b-2">
          {tabs.map((tab) => (
