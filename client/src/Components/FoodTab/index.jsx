...
const LargeTabs = () => {
    ...
    return (
        <>
        <div className="hidden lg:flex gap-14 container px-20 my-7 mx-auto">            
            {allTypes.map((items) => (
                <Link to = {`/${items.id}`}>
               
                <div className={classnames("flex items-center gap-3 pb-3 transition duration-700 ease-in-out", {
             ...
             <div
              ...
              >
                ...
                <h3 className=
                {type === items.id ? "text-xl text-zomato-400" : 
